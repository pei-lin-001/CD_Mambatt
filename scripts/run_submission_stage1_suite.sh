...
run_task \
  "FD003_TO_FD001" \
  "$PROJECT_ROOT/runs/cd_mambatt_bestcfg_fd003_to_fd001_5seeds"

run_task \
  "FD002_TO_FD004" \
  "$PROJECT_ROOT/runs/cd_mambatt_bestcfg_fd002_to_fd004_5seeds"

run_task \
  "FD001_TO_FD004" \
  "$PROJECT_ROOT/runs/cd_mambatt_bestcfg_fd001_to_fd004_5seeds"
